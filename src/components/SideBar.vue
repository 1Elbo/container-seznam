<template>
    <aside>
        ...
        <a href="" @click.prevent="seznamShow">Seznam Kontejnerů</a>
        <a href="" @click.prevent="kontejnerAddShow">Přidat kontejner</a>
    </aside>
</template>
...
export default {
    ...
    setup () {
        ...
        const seznamShow = () => {
            state.seznamActive = true,
            state.kontejnerActive = false
        ...
        const kontejnerAddShow = () => {
            state.seznamActive = false,
            state.kontejnerActive = true
